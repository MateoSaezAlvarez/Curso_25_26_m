 ...
 */
export const registrarUsuario = (username, password, usersObject) => {
...
export const cambiarPassword = (username, passwordActual, passwordNueva, usersObject) => {
    const user = usersObject[username];
    if (!user) {
        console.error("El usuario no existe");
        return false;
